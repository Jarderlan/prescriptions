<?php  
	...
	class Manager extends Connect{
		...
		public function insert_common($table, $data, $query_extra){
			...
			//preparando query a partir dos campos($fields) e os parametros de valores nomeados($values)
			...
			# Essa linha servirá apenas para testes de exibição da query. PADRÃO: COMENTADO
			//echo $query;
		...
		}//Fecha o método INSERT	


		# Metódo de seleção no modo normal, sem relações...
		...
		}//Fecha a o método SELECT SPECIAL
		...
		}//Fecha a o metodo DELETE COMMON

	}// FECHA A CLASSE MANAGER
